...
<main lang="de">
    <card>
        <card-header>
            <h1 class="h3 mb-1">Service Temporarily Unavailable</h1>
        </card-header>
        <card-body>
            <p>Leider ist der Server durch ein internes Problem nicht erreichbar</p>
            <p>Dadurch fallen <b>alle Dienste</b> aus.
                Bitte alarmieren Sie die Sanitäter über öffentliche Laut&shy;spre&shy;cher&shy;durchsagen oder über
                andere Wege</p>
            <p>Ich bitte diese Störung im System zu ent&shy;schul&shy;di&shy;gen. Eine Be&shy;nach&shy;rich&shy;ti&shy;gung
                wurde bereits ausgelöst,
                sie brauchen deshalb keine Support Anfragen schreiben</p>
        </card-body>
    </card>
</main>
